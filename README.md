...
Then, you need to install the Cuvis C SDK (see [here](https://cloud.cubert-gmbh.de/index.php/s/kKVtx0x2fmYqVgx)), as explained for the C++ wrapper [here](https://github.com/cubert-hyperspectral/cuvis.cpp).
